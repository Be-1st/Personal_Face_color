...
class DetectFace:
    ...
    def detect_face_part(self):
        # Initialize face parts list with empty lists
        ...
        self.right_eyebrow = self.extract_face_part(face_parts[1])
        self.left_eyebrow = self.extract_face_part(face_parts[2])
